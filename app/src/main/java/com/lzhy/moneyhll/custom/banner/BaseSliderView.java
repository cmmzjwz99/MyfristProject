...
public abstract class BaseSliderView {
    ...
    public BaseSliderView image(File file) {
        ...
        mFile = file;
        Log.i("BaseSliderView", "image: "+file);
        return this;
    }
    ...
    protected void bindEventAndShow(final View v, ImageView targetImageView) {
        ...
        if (mUrl != null) {
            Log.i("BaseSliderView", "---------网络加载图片: ");
            // FIXME: 2016/11/15 可添加占位图
            rq = p.load(mUrl)
                    .placeholder(R.mipmap.hqroute)
                    .error(R.mipmap.hqroute)
            ;
        } else if (mFile != null) {
            rq = p.load(mFile)
                 .placeholder(R.mipmap.hqroute)
