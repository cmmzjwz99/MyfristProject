package com.lzhy.moneyhll.custom.pulltorefreshlistview;
            ...
            postDelayed(new Runnable() {
                ...
                public void run() {
                    if (!networkIsAvailable(mContext)) {
                        UtilToast.getInstance().myToast((Activity) mContext,"请先连接网络");
                        //// FIXME: 2016/11/15 ouyangmyuan  modefy no net no do
                        hideHeader();
                        return;
                    }
