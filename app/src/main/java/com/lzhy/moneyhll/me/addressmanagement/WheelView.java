...
package com.lzhy.moneyhll.me.addressmanagement;
...
import com.lzhy.moneyhll.me.addressmanagement.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	//*/
    private int[] SHADOWS_COLORS = new int[]{0x9fffffff, 0x9fffffff,
            0x00ffffff, 0x9fffffff, 0x9fffffff};
...
//    }
    ...
    private void drawShadows(Canvas canvas) {
		...
		//*/
        int height = (int) (5 * getItemHeight());
        //*/
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.line_color_2));
        // 设置线宽
...
//        canvas.drawLine(0, center + offset, getWidth(), center + offset, paint);
//        //绘制其他直线
//        canvas.drawLine(0, center - offset - getItemHeight(), getWidth(), center - offset - getItemHeight(), paint);
//        canvas.drawLine(0, center + offset + getItemHeight(), getWidth(), center + offset + getItemHeight(), paint);
