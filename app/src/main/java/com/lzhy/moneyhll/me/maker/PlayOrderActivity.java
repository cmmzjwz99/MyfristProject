 ...
 * 创客方游玩类订单
 */
public class PlayOrderActivity extends MySwipeBackActivity implements ViewPager.OnPageChangeListener {


    private RadioButton rb_wait_pay;
    private RadioButton rb_wait_sure;
    ...
    private void initView() {
        ...
        rb_wait_sure = (RadioButton) findViewById(R.id.rb_wait_sure);
    ...
    private void initAdapter() {
        ...
        typeList.add(MostType.wait_sure);
    ...
    protected class MyAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (typeList.get(position) == MostType.wait_pay) {
                //待支付
                _fragment = new ProjectOrderFragment();
                Bundle bundle = new Bundle();
                bundle.putInt("status", 1);
                _fragment.setArguments(bundle);
            } else if (typeList.get(position) == MostType.wait_sure) {
                //待确认
                _fragment = new ProjectOrderFragment();
                Bundle bundle = new Bundle();
