...
*  用途： 创客商品订单页
*/
public class MakerGoodsOrderActivity extends MySwipeBackActivity implements ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_maker_goods_order);
    ...
    private void initTitlebar() {
        ...
        setTitleBarLeftBtn(titlebar,"商品订单");
    }
    @Override
    ...
    protected class MyAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (typeList.get(position) == MostType.wait_pay) {
                //待支付
                _fragment = new MakerGoodsOrderFm();
